...
public abstract class SimilarityClusterer implements HistoryConverter {
	...
	public SimilarityClusterer(Options options) {
	...
	HistoryCollection clusterInstances(HistoryCollection hc, Instances is,
			...
			CanceledException {
		final int minPoints = calculateMinPoints(is);
